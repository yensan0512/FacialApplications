...
<?php
    ...
    echo '<br>';
    echo '<center><i><h1 style="color:darkblue; text-shadow: 0px 0px;">';
    print_r($fileName);
    echo '</center></i></h1>';
    echo '</br>';
    
    echo '<br>';
    echo '<center><i><h1 style="color:darkblue; text-shadow: 0px 0px;">Your file has been uploaded successfully</center></i></h1>';
    echo '</br>';

    echo '<br>';
    echo '<center><i><h2><a href="run_b.php">Click here for testing</a></center></i></h2>';
