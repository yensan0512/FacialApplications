...
<body>
<?php
echo '<img src="measure/b.jpg" alt="Girl" width="400" height="400" align="left">';
echo '<div class="right">';
echo '<h1 style="color:white; text-shadow: 0px 0px;">Human beauty is based on the Divine Proportion</h1>';
echo '<h1 style="color:white; text-shadow: 0px 0px;">The photo left which illustrates the following golden ratio proportions in the human face:</h1>';
echo '<ul class="sym">';
echo '<li style="color:yellow">Center of pupil : Bottom of teeth : Bottom of chin</li>';
echo '<li style="color:#58D68D">Outer & inner edge of eye: Center of nose</li>';
echo '<li style="color:red">Outer edges of lips : Upper ridges of lips</li>';
echo '<li style="color:DeepSkyBlue">Width of center tooth : Width of second tooth</li>';
echo '<li style="color:purple">Width of eye : Width of iris</li>';
echo '</ul>';
echo '</div>';
