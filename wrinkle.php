...
<h1>Age Wrinkle Analysis</h1>
<h3 style="text-align:center">It can detect your gender, age and wrinkle based on facial landmarks.
...
<a href="cap_age.php" class="button">Capture Image</a>
<a href="dis_age.html" class="button">Upload Image</a>
