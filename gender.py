...
class User(Resource):
    ...
    def post(self):
       ...
       # Load the model mean value
        ...
        wrinkle_list =['It is young','no wrinkle is detected','no wrinkle','no any wrinkle','you still pretty/handsome','wrinkle is detected','wrinkle is serious','there is lots of wrinkle in your face']
